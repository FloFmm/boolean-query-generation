...
DEST=boolean-query-generation/data
mkdir -p "$DEST/statistics"
mkdir -p "$DEST/statistics/optuna"
SOURCE=dataport1.hpc.tu-dresden.de:[Path to your workspace]/boolean-query-generation/data/
...
rsync -av --progress --relative dataport1.hpc.tu-dresden.de:[Path to your workspace]/slurm-*.out $DEST/slurm_logs/

DEST=systematic-review-datasets/data
mkdir -p "$DEST"
mkdir -p "$DEST/rankings"
SOURCE=dataport1.hpc.tu-dresden.de:[Path to your workspace]/systematic-review-datasets/data
