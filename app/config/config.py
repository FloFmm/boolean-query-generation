...
TOP_K = {
    0.7: (
        [1.0, 2.4, 5.0, 8.3, 12.8, 17.5, 24.7, 41.5, 59.8, 87.0, 123.6, 196.2, 303.8, 460.0, 592.7],  # x
        # [17, 34, 27, 58, 99, 98, 218, 210, 362, 578, 875, 776, 2509, 1589, 2937], #y
        [17, 31, 31, 58, 98, 98, 214, 214, 362, 578, 826, 826, 2049, 2049, 2937], # smoothed y
        )
    }
...
TRAIN_REVIEWS_25 = [
    'CD008892', 'CD010864', 'CD010296', 'CD011431', 'CD012010', # tar2018
    'CD008803', 'CD010339', 'CD009591', 'CD008054', 'CD010023', 'CD007427',  #tar2017
    'CD012661', 'CD009069', 'CD001261', 'CD005139', 'CD008874', # tar2019
    'CD007020', # sr_updates
    'CD002783', 'CD006962', 'CD006127', 'CD002117', 'CD005397', 'CD002840', 'CD008963', 'CD003344' # sigir2017
]
TRAIN_REVIEWS = [
    'CD011431', 'CD008892', # tar2018 # starting with the biggest sample (297 positives)
    'CD008054', 'CD007427',  #tar2017
    'CD012661', 'CD005139', # tar2019
    'CD007020', # sr_updates
    'CD002783', 'CD002117', 'CD003344' # sigir2017
]
